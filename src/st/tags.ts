/**
 * Discordia's boundary to SillyTavern's `@scripts/tags` module.
 ...
 */
const mod = await imports('@scripts/tags');

/** Live module namespace — use to read ST bindings that get reassigned at runtime. */
export const tagsModule = mod;

export const { tag_import_setting } = mod;
